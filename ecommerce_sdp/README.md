...
This folder defines all source code for the 'ecommerce_sdp' pipeline:
...
* Take a look at the sample under "sample_users_ecommerce_sdp.py" to get familiar with the syntax.
